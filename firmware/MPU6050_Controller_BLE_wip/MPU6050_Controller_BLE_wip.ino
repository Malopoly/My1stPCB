...
void loop() {
  ...
  int joyX_mapped = map(joyX, -800, 4095 , -255, 255);
  int joyY_mapped = map(joyY, -800, 4095 , -255, 255);

  
    if (int(joyX_mapped) < 20)&& (int(joyX_mapped) > 0) joyX_mapped = 0);
    if (int(joyY_mapped) < 20)&& (int(joyY_mapped) > 0) joyY_mapped = 0);

    if (int(joyX_mapped) < 0)&&(int(joyX_mapped) > -20) joyX_mapped = 0);
    if (int(joyY_mapped) < 0)&&(int(joyY_mapped) > -20) joyY_mapped = 0);
